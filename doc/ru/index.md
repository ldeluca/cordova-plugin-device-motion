...
Этот плагин обеспечивает доступ к устройству акселерометром. Акселерометр является датчик движения, который обнаруживает изменение (*Дельта*) в движении относительно текущей ориентации устройства, в трех измерениях вдоль оси *x*, *y*и *z* .
...
*   **accelerometerOptions**: Объект с следующие необязательные ключи: 
